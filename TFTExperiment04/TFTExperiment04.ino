...
tft.setTextColor(WHITE, BLACK);
            ...
            tft.setAddrWindow(wid - 40 - 40, 60 + 0, wid - 1 - 40, 60 + 39);
...
unsigned long testText() {
    ...
    tft.println("Oliver Dettman");
    tft.println("Portfolio Analyst");
    tft.setTextColor(BLUE); tft.setTextSize(2);
    tft.println("313-845-4176");
    tft.println("odettman@ford.com");
    return micros() - start;
}
